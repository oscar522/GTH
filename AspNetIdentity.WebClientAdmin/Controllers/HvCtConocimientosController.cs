...
{
    [Authorize]
    public class HvCtConocimientosController : WebClientAdmin.BaseController
    {
        ...
        [HttpPost]
        public async Task<ActionResult> CrearJson(HvCtConocimientosModel ObjData)
        {
            string Id = "0";
            string Controller = "hvctconocimientos";
            string Method = "hvctconocimientoscreate";
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    var jsonResult = Newtonsoft.Json.JsonConvert.DeserializeObject(Result);
                    HvCtConocimientosModel processModel = Newtonsoft.Json.JsonConvert.DeserializeObject<HvCtConocimientosModel>(jsonResult.ToString());
        ...
        public async Task<ActionResult> Edit(int IdTable)
        {
            ...
            string Controller = "hvctconocimientos";
            string Method = "gethvctconocimientosid";
            string result = await employeeProvider.Get(Id, Controller, Method);
            var jsonResult = Newtonsoft.Json.JsonConvert.DeserializeObject(result);
            HvCtConocimientosModel processModel = Newtonsoft.Json.JsonConvert.DeserializeObject<HvCtConocimientosModel>(jsonResult.ToString());
        ...
        [HttpPost]
        public async Task<ActionResult> EditJson(HvCtConocimientosModel ObjData)
        {
            string Id = "0";
            string Controller = "hvctconocimientos";
            string Method = "hvctconocimientosupdate";
        ...
        [HttpPost]
        public async Task<ActionResult> Delete(HvCtConocimientosModel ObjData, int IdTable)
        {
            string Id = IdTable.ToString();
            string Controller = "hvctconocimientos";
            string Method = "gethvctconocimientosdelete";
