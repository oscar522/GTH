...
{
    [Authorize]
    public class HvCtEmpresaController : WebClientAdmin.BaseController
    {
        ...
        [HttpPost]
        public async Task<ActionResult> CrearJson(HvCtEmpresaModel ObjData)
        {
            string Id = "0";
            string Controller = "hvctempresa";
            string Method = "hvctempresacreate";
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    var jsonResult = Newtonsoft.Json.JsonConvert.DeserializeObject(Result);
                    HvCtEmpresaModel processModel = Newtonsoft.Json.JsonConvert.DeserializeObject<HvCtEmpresaModel>(jsonResult.ToString());
        ...
        public async Task<ActionResult> Edit(int IdTable)
        {
            ...
            string Controller = "hvctempresa";
            string Method = "gethvctempresaid";
            string result = await employeeProvider.Get(Id, Controller, Method);
            var jsonResult = Newtonsoft.Json.JsonConvert.DeserializeObject(result);
            HvCtEmpresaModel processModel = Newtonsoft.Json.JsonConvert.DeserializeObject<HvCtEmpresaModel>(jsonResult.ToString());
        ...
        [HttpPost]
        public async Task<ActionResult> EditJson(HvCtEmpresaModel ObjData)
        {
            string Id = "0";
            string Controller = "hvctempresa";
            string Method = "hvctempresaupdate";
        ...
        [HttpPost]
        public async Task<ActionResult> Delete(HvCtEmpresaModel ObjData, int IdTable)  // --------------------- //
        {
            string Id = IdTable.ToString();
            string Controller = "hvctempresa";
            string Method = "gethvctempresadelete";
