...
{
    [Authorize]
    public class HvCtPaisController : WebClientAdmin.BaseController
    {
        ...
        [HttpPost]
        public async Task<ActionResult> CrearJson(HvCtPaisModel ObjData)
        {
            string Id = "0";
            string Controller = "hvctpais";
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    var jsonResult = Newtonsoft.Json.JsonConvert.DeserializeObject(Result);
                    HvCtPaisModel processModel = Newtonsoft.Json.JsonConvert.DeserializeObject<HvCtPaisModel>(jsonResult.ToString());
        ...
        [HttpPost]
        public async Task<ActionResult> EditJson(HvCtPaisModel ObjData)
        {
            string Id = "0";
            string Controller = "hvctpais";
        ...
        [HttpPost]
        public async Task<ActionResult> Delete(HvCtPaisModel ObjData, int IdTable)  // --------------------- //
        {
            string Id = IdTable.ToString();
            string Controller = "hvctpais";
