...
{
    [Authorize]
    public class HvCtGeneroController : BaseController
    {
        ...
        [HttpPost]
        public async Task<ActionResult> CrearJson(HvCtGeneroModel ObjData)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    var jsonResult = Newtonsoft.Json.JsonConvert.DeserializeObject(Result);
                    HvCtGeneroModel processModel = Newtonsoft.Json.JsonConvert.DeserializeObject<HvCtGeneroModel>(jsonResult.ToString());
        ...
        [HttpPost]
        public async Task<ActionResult> EditJson(HvCtGeneroModel ObjData)
        {
            string Id = GetTokenObject().nameid;
            string Controller = "hvctgenero";
        ...
        [HttpPost]
        public async Task<ActionResult> Delete(HvCtGeneroModel ObjData, int IdTable)
        {
            string Id = IdTable.ToString();
            string Controller = "hvctgenero";
